...
# Try to import user config but fall back and *force* listening on all interfaces:port 6666
# This makes the server reachable from other devices on the same Wi-Fi network.
try:
...
# Force the listening address and port to what you requested:
HOST = '0.0.0.0'
PORT = 6666
